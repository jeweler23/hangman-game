...
// Создаём функцию возврата на домашний экран
const returnToHomeScreen = () => {
  // Заменяем содержимое блока с игрой на кнопку "Начать игру"
  gameDiv.innerHTML =
...
// Также нам необходимо заменить функцию, которая срабатывает при нажатии на "Play again". Ранее она запускала startGame, теперь же она должна запускать returnToHomeScreen (строка 102 в этом файле)
